...
\newcommand{\AbstraktEN}{
	This~work deals with the~problem of cars transiting through autonomous traffic junction from~the~perspective of~multi-agent path finding (MAPF).
	The~aim is to~explore different abstractions of~the~junction and different approaches to~find collision-free trajectory through the~junction.
