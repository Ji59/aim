...
\newcommand{\Podekovani}{%
	...
	Chtěl bych poděkovat svému vedoucímu prof. RNDr. Romanu Bartákovi, Ph.D. za nemalou pomoc při tvorbě této práce
	a cenné rady, bez kterých bych tuto práci nezvládl dokončit.
	Dále bych rád poděkoval mým rodičům za jejich podporu při studiu a při psaní mé bakalářské práce.
}
...
%%% Jednotlivé kapitoly práce jsou pro přehlednost uloženy v samostatných souborech
	\include{uvod/uvod}
	\include{problem/zavedeni_pojmu}
	\include{algoritmy/algoritmy}
	\include{experimenty/experimenty}
%	\include{kap01}
%	\include{kap02}
%	\include{kap03}
%	\include{kap04}
