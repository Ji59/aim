...
%	\begin{adjustwidth}{-1.5cm}{}
	\begin{tabular}{c c c c | r r D{.}{,}{2.2} D{.}{,}{2.2} D{.}{,}{3.2}}
		...
		\bottomrule
		\multicolumn{9}{l}{\footnotesize \textit{Pozn:}
		\textrm{Zam} - počet zamítnutých agentů
		} \\
		\multicolumn{9}{l}{\footnotesize
		\textrm{pAg} - průměrný počet agentů na křižovatce v jednom kroku
		} \\
		\multicolumn{9}{l}{\footnotesize
		\textrm{pZp} - průměrné zpoždění agentů
		} \\
		\multicolumn{9}{l}{\footnotesize
		\textrm{Čas} - průměrný čas počítání jednoho kroku v mikrosekundách
		}
	\end{tabular}
