...
%	\begin{adjustwidth}{-1.5cm}{}
	\begin{tabular}{c c c c c | r r D{.}{,}{2.2} D{.}{,}{2.2} D{.}{,}{6.2}}
		\toprule \\
		...
		\midrule
		S & n  & 1 & 32  & 32 & 32840 & \B{11285} & \multicolumn{1}{B{.}{,}{3.2}}{159.15} & 35.46                                & \multicolumn{1}{B{.}{,}{6.2}}{204258.46} \\
...
%		}  TODO
	\end{tabular}
	\caption{Porovnání vlivu parametrů u \nameref{subsubsec:a_star_aoid} na různých typech velké křižovatky.}\label{tab:aoid_exp_velka}
%	\end{adjustwidth}
\end{table}
