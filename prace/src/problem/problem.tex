\chapter{Problém křižovatky}\label{ch:problem}
...
Hlavní cíl této práce jsou následující dva přístupy: \emph{\nameref{sec:individualni_planovani}} a \emph{\nameref{sec:hromadne_planovani}}.
...
Agenti jsou plánováni pomocí \nameref{str:fcfs} strategie.
...
Tento způsob řešení je spíše vhodný pro optimalizování \nameref{str:makespan} funkce,
...
\subsubsection{Řešení~online~MAPF}\label{subsubsec:reseni-online-mapf}
