...
class CollisionsTest {
	...
	void getTimeShiftCollisionsTestSimple() {
		@NotNull Map<Long, AgentPolygon> lastState = new HashMap<>();
		lastState.put(0L, new AgentPolygon(0, 0, 0, 0, 1, 1, 1, 1, 0));
		@NotNull Map<Long, AgentPolygon> newState = new HashMap<>();
		newState.put(0L, new AgentPolygon(0, 2, 0, 2, 1, 3, 1, 3, 0));

		@NotNull Set<Collision> collisions = getTimeShiftCollisions(lastState, newState);
